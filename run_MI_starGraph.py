...
if __name__ == '__main__':
    ...
    for r in range(args.runs):
        ...
        for i, T in enumerate(temps):
            ...
            MI, corr = infoTheory.pairwiseMI_allNodes(model, nodes, fullSnapshots.reshape((args.repeats*args.numSamplesJoint, -1)), distMax=maxDist)
        ...
        with open(f'{targetDirectory}/MI_vector_Ts_{now}.pickle', 'wb') as f:
